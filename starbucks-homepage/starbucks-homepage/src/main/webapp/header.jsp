...
<header>
        <div class="inner">
            <a href="http://localhost:8080/starbucks-homepage/" class="logo">
                <img src="./images/starbucks_logo.png" alt="스타벅스" />
            </a>
            ...
            <ul class="main-menu">
                ...
                <li class="item">
                    <div class="item__name">RESPONSEBILITY</div>
                    <div class="item__contents">
                        <div class="contents__menu">
                        </div>
                        <div class="contents__texture"></div>
                ...
                <li class="item">
                    <div class="item__name">MY STARRBUCKS REWARDS</div>
                    <div class="item__contents">
                        <div class="contents__menu"></div>
                        <div class="contents__texture"></div>
                    </div>
